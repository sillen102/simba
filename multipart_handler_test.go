...
func TestMultipartHandler(t *testing.T) {
	...
	t.Run("multipart file and params", func(t *testing.T) {
		handler := func(ctx context.Context, req *models.MultipartRequest[simbaTest.Params]) (*models.Response[map[string]string], error) {
	...
	t.Run("no params", func(t *testing.T) {
		handler := func(ctx context.Context, req *models.MultipartRequest[models.NoParams]) (*models.Response[map[string]string], error) {
			return &models.Response[map[string]string]{
				Headers: map[string][]string{"My-Header": {"header-value"}},
				Cookies: []*http.Cookie{{Name: "My-Cookie", Value: "cookie-value"}},
				Body:    map[string]string{"message": "success"},
	...
	t.Run("default values on params", func(t *testing.T) {
		handler := func(ctx context.Context, req *models.MultipartRequest[simbaTest.Params]) (*models.Response[models.NoBody], error) {
...
func TestMultipartHandlerErrors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			handler := func(ctx context.Context, req *models.MultipartRequest[models.NoParams]) (*models.Response[models.NoBody], error) {
...
func TestAuthenticatedMultipartHandler(t *testing.T) {
	...
	customAuthHandler := auth.BearerAuthType[*simbaTest.User]{
	...
	t.Run("authenticated multipart handler", func(t *testing.T) {
		handler := func(ctx context.Context, req *models.MultipartRequest[simbaTest.Params], authModel *simbaTest.User) (*models.Response[models.NoBody], error) {
	...
	t.Run("authenticated multipart handler with error", func(t *testing.T) {
		handler := func(ctx context.Context, req *models.MultipartRequest[simbaTest.Params], user *simbaTest.User) (*models.Response[models.NoBody], error) {
			return &models.Response[models.NoBody]{}, nil
		}
