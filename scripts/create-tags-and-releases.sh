...
if [ -n "${DRY_RUN:-}" ]; then
  echo "[dry-run] Would create annotated tags: ${ROOT_TAG}, ${WS_TAG}, ${TL_TAG}"
  echo "[dry-run] Would push tags to origin"
  echo "[dry-run] Would create GitHub prereleases for: ${ROOT_TAG}, ${WS_TAG}, ${TL_TAG}"
else
